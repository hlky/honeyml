...
from honey.utils.environ import shorten_tensor_names_for_plots
from honey.utils.misc import short_str
from honey.utils.visualization import op_attr_factory, pydot
from honey.utils.visualization.op_attr_factory import op_to_content
from honey.utils.visualization.web_template import (
    INDEX_TEMPLATE,
    MODAL_TEMPLATE,
    TABLE_TEMPLATE,
)
...
def plot_graph(
    ...
    tensors : Union[Tensor, List[Tensor]]
        An output Tensor, or a list of output Tensors of Honey graph.
    file_path : str
    ...
    from honey.utils.json_utils import gen_unique_op_names

    op_names = gen_unique_op_names(sorted_graph)

    from honey.utils.graph_utils import ProfiledTimeStatistics, track_graph_timings
