...
from honey.utils.visualization import plot_graph
...
def sorted_graph_debug_json(tensors) -> str:
    from honey.compiler.base import Tensor
    from honey.utils.json_utils import gen_unique_op_names, GraphJsonEncoder
...
def track_graph_timings(
    ...
    ----------
    tensors : List[Tensor]
        a list of output Tensors of Honey graph
