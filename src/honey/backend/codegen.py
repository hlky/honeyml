...
from honey.backend.main_templates import MODEL_CONTAINER_TEMPLATE, MODEL_TEMPLATE
from honey.backend.target import Target

from honey.compiler.base import IntImm, IntVar, IntVarTensor, Operator, Tensor
from honey.compiler.dtype import dtype_to_enumerator, get_dtype_size
from honey.compiler.tensor_accessor import TensorAccessor

from honey.compiler.transform.memory_planning import Workspace
from honey.compiler.workspace import workspace_mode, WorkspaceAllocationMode
from honey.utils.debug_settings import HoneyDebugSettings
from honey.utils.environ import (
    allocation_mode,
    multistream_additional_streams,
    multistream_max_mem_parallel_ops,
    multistream_mode,
)
from honey.utils.graph_utils import split_simple_multistream_parallel_ops
from honey.utils.misc import is_debug, is_windows
...
def gen_profiler(sorted_graph: List[Tensor], workdir: str, dynamic_profiling_strategy):
    ...
    dynamic_profiling_strategy: DynamicProfileStrategy, optional
        ...
        See also: :func:`~honey.compiler.transform.profile.profile`
    """
    results = []
...
class ModelContainerGenerator:
    def __init__(
        ...
        debug_settings: Optional[HoneyDebugSettings] = None,
        ...
        self.debug_settings = (
            HoneyDebugSettings() if debug_settings is None else debug_settings
        )
    ...
    def _generate_simple_multistream_ops(
        ...
        from honey.utils.graph_utils import track_graph_timings
