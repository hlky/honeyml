...
from honey.compiler.dtype import normalize_dtype
from honey.compiler.ops.b2b_bmm.b2b_bmm_base import CausalType
from honey.frontend.nn.module import Module as HoneyModule
...
def benchmark_module(
    ...
    graph_mode = False
    t, _, __ = honey_mod.benchmark_with_tensors(
        [inputs],
        [outputs],
        count=iters,
    ...
    # benchmark
    t_honey, _, __ = honey_mod.benchmark_with_tensors(
        [inputs],
        [outputs],
        count=iters,
        graph_mode=graph_mode,
    ...
    print(
        f"{name}_honey: batch_size: {batch_size}, {t_honey} ms",
    )
