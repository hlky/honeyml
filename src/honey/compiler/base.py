...
from honey.compiler import symbolic
from honey.compiler.dtype import get_dtype_size, normalize_dtype
from honey.compiler.op_registry import OP_REGISTRY

from honey.compiler.stable_set import StableSet

from honey.utils.tensor_utils import wrap_dim
...
class JaggedIntVar(IntVar):
    ...
    Because JaggedIntVar is an IntVar, it can be treated so by the Honey ops
    ...
    def offsets_struct_type(self) -> str:
        ...
        return f"honey::JaggedOffsets<{self.offsets_type()}, {num_jagged_dims}>"
...
class Tensor(Node):
    ...
    def __init__(
        ...
        original_name : str, optional
            Original name of this tensor before making it Honey friendly
        """
        super().__init__()
