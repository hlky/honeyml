...
from honey.compiler.transform.mark_param_tensor import mark_param_tensor
from honey.compiler.transform.name_graph import name_graph
...
def check_graph_validity(sorted_graph: List[Tensor], raiseError: bool = False) -> bool:
    """
    Check whether all tensor/op in the Honey graph matches.
