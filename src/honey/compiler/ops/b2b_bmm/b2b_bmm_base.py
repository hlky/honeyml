...
from honey.compiler.base import IntImm, IntVar, Operator
from honey.utils.alignment import find_max_alignment, get_alignments
...
class b2b_bmm_base(Operator):
    ...
    * epilogue_math_name (str): Name of the activation function.
      ...
      python/honey/utils/mk_cutlass_lib/extra_enum.py.
    ...
    def __init__(
        ...
        if epilogue_math_name not in cutlass_lib.library.EpilogueMathName:
            raise RuntimeError(
                ...
                "python/honey/utils/mk_cutlass_lib/extra_enum.py for a list of supported epilogue functions."
            )
