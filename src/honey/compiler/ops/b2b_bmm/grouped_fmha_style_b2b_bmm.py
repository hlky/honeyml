...
from honey.compiler.ops.b2b_bmm.fmha_style_b2b_bmm import (
    CausalType,
    fmha_style_b2b_bmm,
)
...
class grouped_fmha_style_b2b_bmm(fmha_style_b2b_bmm):
    ...
    def __init__(
        ...
        Check honey.compiler.ops.b2b_bmm.b2b_bmm_base for more details
        about these args.
        """
        super().__init__(
    ...
    def _infer_shapes(self):
        ...
        if len(self._attrs["inputs"]) == 4:
            ...
            # Note: jagged_dims min / max values cannot be IntVar, as Honey lacks the feature to set
            ...
            # At runtime, Q / K / V are inputs passed to Honey runtime. However, since
            # min_seq_len / max_seq_len is not bound to any input dimensions,
            # there are no ways for Honey to infer these values. As a result, Honey compilation would
            # fail.
            #
