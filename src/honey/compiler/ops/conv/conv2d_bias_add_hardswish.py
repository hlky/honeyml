...
"""
from honey.compiler.ops.conv.common_conv2d_bias_add_activation import (
...
class conv2d_bias_add_hardswish(conv2d_bias_add_activation):
    ...
    .. code-block:: python
        ...
        OP = honey.compiler.ops.conv2d_bias_add_hardswish(stride=1, pad=1, dilate=1)
        Y = OP(X, W, B, R)
