...
from honey.compiler.ops.conv.cache_entry import ConvQueryEntry, ConvRecordEntry
from honey.compiler.ops.conv.conv_common import (
    filter_op_instances,
...
class conv2d(Operator):
    ...
    * :attr:`group` controls the number of blocked connections from input channels
    ...
    .. code-block:: python
        ...
        OP = honey.compiler.ops.conv2d(stride=1, pad=1, dilate=1)
        Y = OP(X, W)
