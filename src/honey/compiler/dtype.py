...
#
"""
dtype definitions and utility functions of Honey
"""
...
# Maps dtype strings to HoneyDtype enum in model_interface.h.
# Must be kept in sync!
# We can consider defining an HoneyDtype enum to use on the Python
...
def dtype_str_to_enum(dtype: str) -> int:
    """Returns the HoneyDtype enum value (defined in model_interface.h) of
    the given dtype str.
...
def dtype_to_enumerator(dtype: str) -> str:
    """Returns the string representation of the HoneyDtype enum
    ...
    ----------
    str
        the HoneyDtype enum string representation.
    """
    ...
    return f"HoneyDtype::{_impl(dtype)}"
