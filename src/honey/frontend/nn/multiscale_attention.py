...
from honey.compiler.public import permute
...
from honey.frontend.nn.dropout import Dropout, DropPath
from honey.frontend.nn.identity import Identity
from honey.frontend.nn.layer_norm import LayerNorm
from honey.frontend.nn.linear import Linear
...
class MultiScaleBlock(Module):
    ...
    def forward(
        ...
        x_norm = (
            honey_ncl2nlc(self.norm1(honey_ncl2nlc(x)))
        ...
        x_norm = (
            honey_ncl2nlc(self.norm2(honey_ncl2nlc(x)))
