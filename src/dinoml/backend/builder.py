...
from dinoml.utils.environ import is_cmake_compilation
...
class Builder:
    ...
    def __init__(self, n_jobs: int = -1, timeout: int = 180) -> None:
        ...
        self._do_trace = os.environ.get("DINOML_TRACE_MAKE", False)
...
"""
        ...
        obj_files = []
        # * standalone.cu is an DinoML internal file that is used for generating
...
"""
    ...
    def make_profilers(self, generated_profilers, workdir):
        ...
        _run_make_cmds(
            ...
            self._timeout,
            build_dir,
            allow_cache=(not environ.dinoml_build_cache_skip_profiler()),
        )
