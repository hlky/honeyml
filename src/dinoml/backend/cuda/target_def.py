...
from dinoml.utils.misc import is_debug
...
class CUDA(Target):
    ...
    def __init__(
        ...
        dinoml_static_files_path=DINOML_STATIC_FILES_PATH,
        arch="80",
        cuda_version=None,
        **kwargs,
    ):
        ...
        dinoml_static_files_path : str
            Absolute path to the DinoML static/ directory
        """
        super().__init__(dinoml_static_files_path)
        self._target_type = 1
        self._template_path = template_path
        self._dinoml_include_path = dinoml_static_files_path
        self._arch = arch
        self._kwargs = kwargs
    ...
    def _build_include_directories(self) -> List[str]:
        ...
        dinoml_kernels_static_path = os.path.join(
    ...
    def _build_nvcc_compiler_options(self) -> List[str]:
        ...
        if (
            ...
            options.extend(
                [
                    "-DDINOML_USE_TANH_FOR_SIGMOID=1",
    ...
    def _gen_cutlass_lib_pkg(self):
        self.lib_folder = "src/dinoml/utils/cutlass_lib"
