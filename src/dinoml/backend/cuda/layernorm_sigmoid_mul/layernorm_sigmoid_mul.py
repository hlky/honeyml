...
from dinoml.backend.common import tensor_accessor_codegen
from dinoml.backend.cuda.layernorm_sigmoid_mul import layernorm_common
...
{% if layernorm_use_welford_algorithm %}
#include "kernels/cuda/layer_norm.cuh"
#include "kernels/cuda/layernorm_welford.cuh"
{% else %}
#include "kernels/cuda/layernorm_sigmoid_mul_kernel.cuh"
{% endif %}
