...
__DINOML_CACHE_VERSION__ = 3


def dinoml_cache_version() -> int:
    return __DINOML_CACHE_VERSION__
...
class ProfileCacheDB:
    ...
    def __init__(
        ...
        self._gemm_cache_version = dinoml_cache_version()
        self._conv_cache_version = dinoml_cache_version()
        self._conv3d_cache_version = dinoml_cache_version()
        if uri is not None:
