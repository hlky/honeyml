...
DinoML implementation for MViT:
...
from dinoml.compiler.public import permute
...
from dinoml.frontend.nn.dropout import Dropout, DropPath
from dinoml.frontend.nn.identity import Identity
from dinoml.frontend.nn.layer_norm import LayerNorm
from dinoml.frontend.nn.linear import Linear
...
class MultiScaleBlock(Module):
    ...
    def forward(
        ...
        x_norm = (
            dinoml_ncl2nlc(self.norm1(dinoml_ncl2nlc(x)))
        ...
        x_norm = (
            dinoml_ncl2nlc(self.norm2(dinoml_ncl2nlc(x)))
