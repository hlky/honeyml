...
from dinoml.compiler.base import IntVar, JaggedDim, JaggedIntVar, Operator, Tensor
from dinoml.compiler.ops.common.view_ops import make_jagged
...
class padded_dense_to_jagged(Operator):
    ...
    def __call__(
        ...
        # in the DinoML graph, the output of the padded_dense_to_jagged op is set to
