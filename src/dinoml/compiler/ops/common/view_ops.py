...
from dinoml.compiler.symbolic import (
...
from dinoml.utils.shape_utils import convert_shape_to_IntVar, gen_int_var_min_max
...
class make_jagged(_view):
    ...
    IntVar). The purpose of this op is to take a normal DinoML Tensor "source"
    ...
    *Important*: this op is the only right way to create a jagged Tensor.
    ...
    def __call__(
        ...
        for s in sources_list:
            ...
            if not isinstance(s._attrs["shape"][0], IntVar):
                raise ValueError(
