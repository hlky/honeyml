...
from dinoml.utils.visualization import plot_graph
...
def sorted_graph_debug_json(tensors) -> str:
    from dinoml.compiler.base import Tensor
    from dinoml.utils.json_utils import gen_unique_op_names, GraphJsonEncoder
...
def track_graph_timings(
    ...
    ----------
    tensors : List[Tensor]
        a list of output Tensors of DinoML graph
