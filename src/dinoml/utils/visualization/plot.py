...
#
"""
Graph visualization tool for DinoML
"""
...
from dinoml.utils.environ import shorten_tensor_names_for_plots
from dinoml.utils.misc import short_str
from dinoml.utils.visualization import op_attr_factory, pydot
from dinoml.utils.visualization.op_attr_factory import op_to_content
from dinoml.utils.visualization.web_template import (
    INDEX_TEMPLATE,
    MODAL_TEMPLATE,
    TABLE_TEMPLATE,
)
...
def plot_graph(
    ...
    tensors : Union[Tensor, List[Tensor]]
        An output Tensor, or a list of output Tensors of DinoML graph.
    file_path : str
    ...
    from dinoml.utils.json_utils import gen_unique_op_names

    op_names = gen_unique_op_names(sorted_graph)

    from dinoml.utils.graph_utils import ProfiledTimeStatistics, track_graph_timings
